...
contract CoralMarketContract {

    // Need to add functionality for bidding on items
    // Need to add functionality for seller to wirthdraw an item from the marketplace
    ...
    modifier IsForSale(uint256 id){
        require(itemsForSale[id].isSold == false, "Could not find item" );
        _;
    }
